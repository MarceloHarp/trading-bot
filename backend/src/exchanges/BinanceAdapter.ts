...
export class BinanceAdapter implements IExchangeAdapter {
  ...
  // Velas de Binance REAL (publico, sin API key) — para historial largo en el grafico
  async getCandlesPublic(symbol: string, interval: string, limit = 1000): Promise<Candle[]> {
    try {
